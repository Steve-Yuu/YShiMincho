...
## 简介
本字体是基于华英明朝、 [IPAmj明朝](https://moji.or.jp/mojikiban/font/) ，并借用一点明朝，修改的中文开源字体。字体以传统字形为主，基于IPAmj明朝修改的旧字形字体目前有华英明朝、一点明朝。
...
依据协议，您可以：
* 免费商用本字体，无论是个人还是商用，均无需告知原作者
* 自由修改、分发、传播
* 将本字体安装、嵌入
但是，以下行为您不可以做：
* 使用本字体保留名称（如<span lang="zh-cn">「YShi明朝体」</span>
